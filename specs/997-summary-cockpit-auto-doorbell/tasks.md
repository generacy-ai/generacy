...
- [ ] T001 [US1][US2][US3] Update `packages/generacy/src/cli/commands/cockpit/doorbell/source-selector.ts`:
...
- [ ] T002 [US1][US3] Update `packages/generacy/src/cli/commands/cockpit/doorbell/smee-source.ts`:
...
- [ ] T003 [US1][US2][US3] Update `packages/generacy/src/cli/commands/cockpit/doorbell.ts`:
...
- [ ] T004 [US1][US2][US3] Update `packages/generacy/src/cli/commands/cockpit/doorbell/__tests__/source-selector.test.ts`:
...
- [ ] T005 [P][US1][US2][US3] Create `packages/generacy/src/cli/commands/cockpit/doorbell/__tests__/doorbell-bridge.test.ts` (NEW file):
...
- [ ] T006 [P] Create `.changeset/997-doorbell-bridge-mode.md` (NEW file):
...
- [ ] T007 Run local verification before pushing:
