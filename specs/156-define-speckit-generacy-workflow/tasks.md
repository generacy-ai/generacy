...
### [X] T001 Add 'speckit' to ActionType union
...
### [X] T002 [P] Update parseActionType for speckit.* pattern
**File**: `packages/workflow-engine/src/types/action.ts`
...
### [X] T003 [P] Add gate field to StepDefinition
...
### [X] T004 [P] Update Zod schema for gate field
...
### [X] T005 Create SpecKitAction base class structure
**Files**:
...
### [X] T006 Port create_feature library logic
**Files**:
...
### [X] T007 [P] Port get_paths library logic
**Files**:
...
### [X] T008 [P] Port check_prereqs library logic
**Files**:
...
### [X] T009 [P] Port copy_template library logic
**Files**:
...
### [X] T010 Create shared filesystem utilities
...
### [X] T011 Implement speckit.specify operation
...
### [X] T012 [P] Implement speckit.clarify operation
...
### [X] T013 [P] Implement speckit.plan operation
...
### [X] T014 [P] Implement speckit.tasks operation
...
### [X] T015 Implement speckit.implement operation
...
### [X] T016 Update workflow executor for gate handling
...
### [X] T017 [P] Implement gate handler interface
**Files**:
...
### [X] T018 Create speckit-feature.yaml template
...
### [X] T019 [P] Create speckit-epic.yaml template
...
### [X] T020 [P] Create speckit-bugfix.yaml template
...
### [X] T021 Write unit tests for SpecKitAction dispatch
...
### [X] T022 [P] Write unit tests for deterministic operations
**Files**:
...
### [X] T023 [P] Write unit tests for AI operations
**Files**:
...
### [X] T024 Write integration test for full workflow
...
### [X] T025 Register SpecKitAction in action registry
...
### [X] T026 Update README with speckit action documentation
