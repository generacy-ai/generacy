...
- [ ] T001 Create relay type definitions in `packages/orchestrator/src/types/relay.ts`
...
- [ ] T002 [P] Add `RelayConfigSchema` to `packages/orchestrator/src/config/schema.ts`
...
- [ ] T003 [P] Map `GENERACY_API_KEY` env var in `packages/orchestrator/src/config/loader.ts`
...
- [ ] T004 Create `RelayBridge` service in `packages/orchestrator/src/services/relay-bridge.ts`
...
- [ ] T005 Write unit tests in `packages/orchestrator/src/services/__tests__/relay-bridge.test.ts`
...
- [ ] T006 Wire `RelayBridge` into `packages/orchestrator/src/server.ts`
...
- [ ] T007 [P] Add relay re-exports to `packages/orchestrator/src/index.ts`
