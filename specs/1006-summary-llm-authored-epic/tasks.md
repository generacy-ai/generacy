...
- [X] T001 [P] [US1] Create fixture file at `packages/cockpit/src/resolver/__tests__/fixtures/epic-1006-snappoll.md`.
...
- [X] T002 [US1] Modify `packages/cockpit/src/resolver/parse-epic-body.ts`:
...
- [X] T003 [US1] Extend `packages/cockpit/src/resolver/__tests__/parse-epic-body.test.ts` with a new `describe("H4 phase-header detector (#1006)", …)` block containing:
...
- [X] T004 [US1] Modify `packages/generacy/src/cli/commands/cockpit/status/render-table.ts`:
...
- [X] T005 [US1] Modify `packages/generacy/src/cli/commands/cockpit/status.ts`:
...
- [X] T006 [P] [US1] Extend `packages/generacy/src/cli/commands/cockpit/__tests__/status.test.ts` (or add a new sibling `status.warnings.test.ts` if the file is already crowded):
...
- [X] T007 [P] [US1] Extend `packages/generacy/src/cli/commands/cockpit/mcp/__tests__/parity-status.test.ts`:
...
- [X] T008 [US1] Run the local verification loop from `quickstart.md`:
