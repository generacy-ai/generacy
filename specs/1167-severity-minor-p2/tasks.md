...
- [ ] T001 [P] [US1] In `docs/docs/guides/generacy/review-remediate-migration.md` §2
...
- [ ] T002 [P] [US1] In `docs/docs/guides/generacy/review-remediate-migration.md`
...
- [ ] T003 [P] [US1] In `docs/docs/guides/generacy/review-remediate-migration.md` §3
...
- [ ] T004 [P] [US1] In `docs/docs/guides/generacy/review-remediate-migration.md` §5
...
- [ ] T005 [P] [US1] In `docs/docs/reference/bugfix-profile-config.md` §Precedence
...
- [ ] T006 [US2] In `packages/orchestrator/src/worker/phase-loop.ts`, fix the two
...
- [ ] T007 [US2] Verify-and-skip FR-005 and FR-007 (already resolved at HEAD by
...
- [ ] T008 [P] [US3] In `packages/cockpit/src/state/precedence.ts`
...
- [ ] T009 [P] [US3] In `packages/cockpit/src/state/precedence.ts`
...
- [ ] T010 [P] [US3] In `packages/workflow-engine/src/types/github.ts`, extend the
  `ReviewGate` union (~line 256) with `| 'remediation-limit'` and `| 'ci'`
  (FR-010). Type-surface only — no new capability.

- [ ] T011 [US3] Verify-and-skip FR-011 (already unified at HEAD by #1161).
...
- [ ] T012 Add `.changeset/1167-reconcile-review-remediate-docs.md`. The two `src/`
...
- [ ] T013 Verify SC-004 (zero behavior change): run the existing test suites for
