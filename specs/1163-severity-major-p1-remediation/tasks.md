...
- [ ] T003 [US2] In `packages/cockpit/src/gates/fixtures.ts`, add a `remediation-limit` and a `ci` entry to each of the four exhaustive `Record<GateType, …>` maps:
