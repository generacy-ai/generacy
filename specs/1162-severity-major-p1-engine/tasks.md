...
- [X] T001 [US1] In `packages/orchestrator/src/worker/product-diff.ts`, add the single source
...
- [X] T002 [US1] In `packages/orchestrator/src/worker/pr-manager.ts`, `commitAndPush` (~`:125`,
...
- [X] T003 [US1] Add `packages/orchestrator/src/worker/__tests__/pr-manager.staging-filter.test.ts`
...
- [X] T004 [P] [US1] Add `packages/orchestrator/src/worker/__tests__/product-diff.test.ts`
...
- [X] T005 [US2] In `packages/orchestrator/src/worker/review-artifact.ts`, add
...
- [X] T006 [US2] In `packages/orchestrator/src/worker/phase-loop.ts`, add the Redis mirror +
...
- [X] T007 [US2] Add `packages/orchestrator/src/worker/__tests__/phase-loop.remediation-persist.test.ts`
...
- [X] T008 [P] [US3] Verify `specs/1162-severity-major-p1-engine/scripts/cleanup-committed-sidecars.sh`
...
- [X] T009 Add `.changeset/1162-engine-sidecar-staging.md` — `@generacy-ai/orchestrator`
...
- [X] T010 Run `pnpm --filter @generacy-ai/orchestrator test` (the three new test files) and
