...
- [X] T001 [US1] Add the two heading-grammar regexes as module-level constants in `packages/orchestrator/src/worker/tasks-md-fallback.ts`, alongside the existing `CHECKBOX_LINE`:
