...
- [ ] T001 [US1] Add `webhooksConfigured: boolean` to `MonitorState` in `packages/orchestrator/src/types/monitor.ts` (per data-model.md §`MonitorState`; JSDoc distinguishes from `webhookHealthy`).
