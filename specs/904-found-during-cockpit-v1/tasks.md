...
- [X] T008 [US1] Update `packages/generacy/src/cli/commands/cockpit/context.ts:266` (`buildImplementationReviewBundle`) to switch on the new union. Replace `if (prRef == null)` with `switch (resolution.kind)`:
