...
- [X] T001 [US1] Add `handleGetCredentialValue` handler in `packages/control-plane/src/routes/credentials.ts`
...
- [X] T002 [US1] Register route `GET /credentials/:id/value` in `packages/control-plane/src/router.ts`
...
- [X] T003 [P] [US1] Create `packages/generacy/src/cli/utils/docker-config.ts`
...
- [X] T004 [P] [US1] Add `extractImageHost` helper in `packages/generacy/src/cli/commands/update/index.ts` (or a local util)
...
- [X] T005 [US1] Add `fetchRegistryCredential` helper in update command
...
- [X] T006 [US1] [US2] Modify `updateCommand` action in `packages/generacy/src/cli/commands/update/index.ts`
...
- [X] T007 [US2] Add env option support to `runCompose` in `packages/generacy/src/cli/commands/cluster/compose.ts`
...
- [X] T008 [P] [US1] Unit tests for `handleGetCredentialValue` endpoint
...
- [X] T009 [P] [US1] Unit tests for `docker-config.ts` utility
...
- [X] T010 [P] [US1] [US2] Unit tests for update command credential flow
