 ...
 */
export function getActionType(step: WorkflowStep): ActionType {
  return parseActionType(step);
}

// Action handlers
import { WorkspacePrepareAction } from './workspace-prepare';
import { AgentInvokeAction } from './agent-invoke';
...
export { parseActionType } from './types';
export { BaseAction } from './base-action';

// Re-export action classes
export { WorkspacePrepareAction } from './workspace-prepare';
export { AgentInvokeAction } from './agent-invoke';
