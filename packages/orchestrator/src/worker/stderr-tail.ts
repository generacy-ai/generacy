...
const EMPTY_LITERAL = '(stderr empty)';

/**
 * Bound a raw stderr string into a compact tail suitable for a GitHub comment.
 *
 * Contract (see specs/847-found-during-cockpit-v1/data-model.md):
